...
class StormArticle(Article):
    def __init__(self, opportunity_name):
        super().__init__(opportunity_name=opportunity_name)
    ...
    @classmethod
    def from_outline_file(cls, opportunity: str, file_path: str):
        """
    ...
    @classmethod
    def from_outline_str(cls, opportunity: str, outline_str: str):
        """
    ...
    @classmethod
    def from_string(cls, opportunity_name: str, article_text: str, references: dict):
        article_dict = ArticleTextProcessing.parse_article_into_dict(article_text)
        article = cls(opportunity_name=opportunity_name)
